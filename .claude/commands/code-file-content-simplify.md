---
argument-hint: [file]
description: Simplify and improve code content
---

# Simplify and improve code content

## Prerequisites

You MUST read the following skills.
...
## Code File Content Simplify Command
...
- Use the planning-code-file-content-simplification skill to enter planning mode and create a plan.
- Execute the plan.
