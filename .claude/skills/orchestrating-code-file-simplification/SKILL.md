---
name: orchestrating-code-file-simplification
description: You are working on the content of a specific code file, to simplify and improve it from an understandability, maintainability and debuggability perspective, you use best practises to do this.
---

# Simplifying Code File Skill

This skill provides information on how to orchestrate the process of simplifying the content of a file.  The goal is to improve the existing code so that it is more logically organised, understandable, maintainable and more easily debugged.  You must use language best practises to do this.

## Simplifying Code File Workflow
...
5. Think and create a step by step high level plan for simplifying the code area, make sure you use the orchestrating-code-simplification and developing-csharp-code skills for this task.  Apply best practises outlined in these skills.
