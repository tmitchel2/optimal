...
2. Before starting, ensure that there are unit tests for the file to be simplified and that they provide comprehensive line coverage, approximately 90% or more.  The tests can be updated but the intent behind each test should not change.

## Your task

1. Determine the code you have been asked to simplify and ensure it exists.
2. Think and create a step by step plan for simplifying the code, make sure you use the simplifying-code and developing-csharp-code skills for this task.
