...
var commands = new Dictionary<string, ICommand>
{
    ...
    { "brachistochrone-alt", new BrachistochroneProblemSolverAlternate() },
...
static void ShowHelp()
{
    ...
    Console.WriteLine("  brachistochrone-alt  - Brachistochrone with arc-length parameterization");
    ...
    Console.WriteLine("  OptimalCli brachistochrone -v running");
    Console.WriteLine();
}
