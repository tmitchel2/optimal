...
Files needing improved code coverage for Optimal.csproj, ordered by coverage ratio (lowest first).
...
- [ ] `src/Optimal/Control.Collocation/LegendreGaussLobatto.cs` - 73.17% (300/410 lines)
- [ ] `src/Optimal/Control.Solvers/MultiPhaseSolver.cs` - 73.3% (258/352 lines)
- [ ] `src/Optimal/NonLinear/ConjugateGradientOptimizer.cs` - 75.36% (312/414 lines)
- [ ] `src/Optimal/NonLinear/GradientDescentOptimizer.cs` - 77.34% (198/256 lines)
- [ ] `src/Optimal/Control.Collocation/ParallelLGLTranscription.cs` - 78.67% (354/450 lines)
- [ ] `src/Optimal/Control.Solvers/ContinuationSolver.cs` - 79.05% (166/210 lines)
- [ ] `src/Optimal/Control.Solvers/WarmStartExtensions.cs` - 80% (16/20 lines)
